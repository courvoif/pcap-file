...
//! [`PcapNgWriter`] to write pcapng data and [`PcapNgReaderIterator`] for iteration over owned packets.
...
pub use reader::{PcapNgPacket, PcapNgReader, PcapNgReaderIterator};
