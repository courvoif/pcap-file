...
impl<'a> Block<'a> {
    ...
    fn section_header(&self) -> Option<&SectionHeaderBlock<'a>> {
        match &self.parsed {
    ...
    pub fn is_interface_description(&self) -> bool {
        self.interface_description().is_some()
    }

    fn enhanced_packet(&self) -> Option<&EnhancedPacketBlock<'a>> {
        match &self.parsed {
    ...
    fn simple_packet(&self) -> Option<&SimplePacketBlock<'a>> {
        match &self.parsed {
